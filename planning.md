    ...
    FACTIONS:
        Superpowers:
            ...
            Federated States of Azea -- "FSA", "Azea",  (macronational affiliation)
                ...
                Ithrasa:
                    Central to Azean society is a bioengineered mutualistic fungus known in common speech as "link fungus" or "Ithrasa" (with a religious traditionalist connotation), and scientifically as "Aurumaculum Reticogitans" (A. Reticogitans). Almost all living things within the territory of Azea host an A. Reticogitans colony at varying stages of aurumaculosis. All such colonies are networked together through a cultivated Ethereal structure known as the "psycelium" or "psycelial network", allowing for rapid, full-duplex data transfer between all colonies linked by the psycelium.
                    
                    While inoculation by previous, more virulent strains developed along a faster schedule, modern strains of aurumaculosis develop slowly, proceeding through a number of discreet stages, often without reaching the final stages at all. 
