...
CAPITALIZED text shows the s of interactable things. Type them in lowercase if you'd like to use them.
...
wizard = {
    ...
    The luminosity of their skin should suffice.
            """,
            "blood":"""
    ...
    Let the dead demcompose in peace...
            """,
            "tables":"""
    ...
    It whispers...
    "I was once in the veins of a guy d Abrahand Lickin'. Hell of a thing, ain't it?"
            """,
            "tome":"""
...
cursed = {
    ...
    However, your arms are paralyzed to far forward.
    You cannot reach its pages with your tongue.
            """,
            "door1":"""
    This door taste like promise.
    Like power.
            """,
            "door2":"""
    This door taste like freedom...
    And death.
            """,
            "window":"""
    You lick the window.
